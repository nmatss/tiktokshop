...
export function AdminModulosClient() {
  ...
  async function loadData() {
    ...
    try {
      ...
      if (course) {
        ...
        // Get modules with lesson count (only needed columns)
    ...
    try {
      if (editingModule) {
        ...
        if (error) {
          ...
          alert('Erro ao atualizar modulo: ' + error.message)
          setSaving(false)
          return
        }
      } else {
        ...
        if (error) {
          ...
          alert('Erro ao criar modulo: ' + error.message)
          setSaving(false)
          return
        }
      }
  ...
  async function handleDelete(id: string) {
    ...
    try {
      ...
      if (error) {
        ...
        alert('Erro ao excluir modulo: ' + error.message)
        return
      }
